...
async function insertDummyData() {
    try {
        ...
        for (let i = 0; i < 1000; i++) {
            const title = faker.hacker.phrase(); // Using the "hacker" category for more technical titles
            ...
            const query = 'INSERT INTO backend.queries (title, body, user_id, created_at) VALUES ($1, $2, $3, $4)';
            await pool.query(query, [title, body, userId, created_at]);
        }
